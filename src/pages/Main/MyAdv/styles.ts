...
export const StyledArticle__ImgBarMob = styled.div`
  display: none;
`;
export const StyledImgBarMob__Circle = styled.div<TrueFalse>`
  ${({ isactive }) => {
    if (isactive === 'true') {
...
export const StyledArticle__Info = styled.div`
  margin-bottom: 34px;
`;
const Styled__ArticleTemp = styled.p`
  font-size: 16px;
  line-height: 21px;
  color: #5f5f5f;
  margin-bottom: 4px;
`;
export const StyledArticle__Date = styled(Styled__ArticleTemp)``;
export const StyledArticle__City = styled(Styled__ArticleTemp)``;
...
export const StyledArticle__Price = styled.p`
  ...
  margin-bottom: 20px;
`;
export const StyledArticle__BtnBlock = styled.div`
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
  -ms-flex-wrap: wrap;
  flex-wrap: wrap;
`;
const StyledArticle__Btn = styled.button`
  background-color: #009ee4;
  border-radius: 6px;
  border: 1px solid #009ee4;
  height: 50px;
...
`;
export const StyledArticle__BtnRedact = styled(StyledArticle__Btn)`
  width: 189px;
  margin-right: 10px;
`;
export const StyledArticle__BtnRemove = styled(StyledArticle__Btn)`
  width: 225px;
`;
