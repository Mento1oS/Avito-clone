...
export const StyledModal__InputLogin = styled(StyledModal__Input)`
  margin-bottom: 30px;
`;
export const StyledModal__InputPassword = styled(StyledModal__Input)``;
export const StyledModal__BtnEnter = styled.button`
  &:hover {
...
`;
export const StyledModal__BtnSignup = styled.button`
  width: 278px;
  height: 52px;
  background-color: transparent;
